...
export default function EditAlertRulePage() {
  ...
  function toggleSensor(sensorId: number) {
    setForm((p) => {
      const exists = p.sensorIds.includes(sensorId);
      return {
        ...p,
        sensorIds: exists
          ? p.sensorIds.filter((x) => x !== sensorId)
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-black/55">
                Atualize os parâmetros da regra de alerta.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <ComboField
              ...
              listId="measurement-type-edit-list"
            />
